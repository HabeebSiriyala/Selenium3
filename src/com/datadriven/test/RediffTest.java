...
public class RediffTest {
	...
	public void setUp(){
		...
		driver.get("https://register.rediff.com/register/register.php?FormName=user_detailshttps://register.rediff.com/register/register.php?FormName=user_details");  //enter URL
	}
